...
class ProductosProvider {
  final String _url =
      'https://flutter-varios-70449-default-rtdb.firebaseio.com';
  ...
  //imagenes load and sync//

  Future<String?> subirImagen(File imagen) async {
    final url = Uri.parse(
        'https://api.cloudinary.com/v1_1/dar2jox2s/image/upload?upload_preset=gceugpdc');
